package com.zhoudewei.learningapplication.resp;

import com.zhoudewei.learningapplication.resp.enums.ResultCodeEnum;

import java.io.Serializable;

/**
 * @author： zhoudewei
 * @date： 2022/1/14 6:03 下午
 * @description： Restful接口统一返回格式
 * @version： v1.0
 */
